      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">Hype Market</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><a href="/lives" className="hover:text-white">Lives</a></li>
              <li><a href="/categories" className="hover:text-white">Catégories</a></li>
              <li><a href="/boutiques" className="hover:text-white">Boutiques</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 Hype Market. Tous droits réservés. Made with ❤️ in Côte d'Ivoire</p>
        </div>
      </div>
    </footer>
  );

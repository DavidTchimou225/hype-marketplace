...
export default function CheckoutPage() {
  ...
  if (items.length === 0) {
    return <div className="min-h-screen flex items-center justify-center">Panier vide.</div>;
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t z-50 py-4 px-4 flex flex-col items-center">
        <div className="w-full max-w-md">
          <button
            type="button"
            onClick={handleSubmit}
            disabled={loading}
            className="w-full bg-black text-white py-4 rounded-xl font-bold text-lg hover:bg-gray-800 transition-colors disabled:bg-gray-400 shadow-xl"
          >

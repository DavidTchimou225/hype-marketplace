  ...
  if (orderComplete) {
    return (
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-md mx-auto bg-white rounded-2xl p-6 text-center mt-20">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full p-3 border border-gray-200 rounded-lg mb-3 focus:outline-none focus:ring-2 focus:ring-black"
              required
            />
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            <label className="flex items-center p-3 border border-gray-200 rounded-lg mb-2 cursor-pointer hover:bg-gray-50">
              <input
                type="radio"
                name="paymentMethod"
                value="mobile_money"
